...
<body>
            ...
            <td style="width: 50%;">
                <table class="mui-table mui-table--bordered">
                    ...
                    <?php 
                         ...
                         */
                        $answersSql = "SELECT * FROM answers ORDER BY ID DESC LIMIT 15";
            ...
            <td style="width: 50%;">
                <table class="mui-table mui-table--bordered">
                    ...
                    <?php 
                        ...
                        $answersSql = "SELECT * FROM rank ORDER BY score DESC LIMIT 15";
                        $answersQuery = mysqli_query($conn, $answersSql);
                        if (!$answersQuery) {die ('SQL Error: ' . mysqli_error($conn));}
    ...
    <div style='min-width: 275px; height: 65px;' align='center' class='footer mui-container'>
